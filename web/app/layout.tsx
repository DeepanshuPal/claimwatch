...
export const metadata: Metadata = {metadataBase:new URL("https://watchmyhandle.com"),title:{default:"Watch My Handle - Know when a name moves",template:"%s - Watch My Handle"},description:"Watch My Handle watches handles and domains and alerts you when availability, ownership, or activity changes.",openGraph:{title:"Watch My Handle",description:"Watch handles and domains. Know when a name moves.",url:"https://watchmyhandle.com",siteName:"Watch My Handle",type:"website"}};
